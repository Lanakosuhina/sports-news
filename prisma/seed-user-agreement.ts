...
<div class="user-agreement-content">
  <p class="document-info">Сайт: Тренды спорта<br>Дата вступления в силу: 30.12.2025<br>Версия: 1.0</p>
  ...
  <div class="highlight">
    <p>© 2025 ООО «МГ Маркетинг». Все права защищены.<br>Последнее обновление: 30.12.2025</p>
  </div>
</div>
  `.trim()
